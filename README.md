...
Да, я впилил сюда рефералку. Свою реферальную ссылку можно сделать в разедел Account.   
...
* GPT-5-pro стоит 120$ за 1M токенов (GPT-5-pro входит в подписку Pro за 229 евро или где-то 250$. Он даже дисертацию накатать может)
* GPT-5 стоит 10$ за 1M токенов (GPT-5 стоит 23 евро или около 25$)
* GPT-5-mini стоит 2$ за 1M токенов
* claude-sonnet-4-5 стоит 15$ за 1M токенов (Лучшая модель для кодинга)
...
Скачиваете на телефон Alipay из плейстора. Регистрируетесь (русские номера отлично принимаются).   
