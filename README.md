...
Для работы надо скачать любое не официальное приложение поддерживающее custom endpoint. Изначально я выбрал [Jan](https://www.jan.ai) (*Но оказалось что он гавно*). [ChatBoxAi](https://chatboxai.app/en) выглядит лучше, но в него не завезли разделения по папочкам. Эти приложения поддерживает большинство нейронок.    
Если вы кодите и проводите всё время в консоле качайте [aichat](https://github.com/sigoden/aichat). Он в разы лучше всего что я находил. Только UI у него нету :D       
А ещё есть плагины с GPT для nvim. Я их не пробовал, но выглядят многообещающе.     
